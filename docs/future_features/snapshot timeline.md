...
- Retention/pruning policy enforced (configurable)
- User priceIndex preserved; inferred values recomputed post-restore (if feature is on)
- Export excludes history by default; optional include-history documented
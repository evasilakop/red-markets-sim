...
- Sources: Blob (developer.mozilla.org/en-US/docs/Web/API/Blob), URL.createObjectURL 
(developer.mozilla.org/en-US/docs/Web/API/URL/createObjectURL_static), File input (developer.mozilla.org/en-US/docs/Web/HTML/Element/input/file)
